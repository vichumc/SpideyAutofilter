...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "**📁 {file_name}</b> \n** **🎞️ SIZE : {file_size}**\n •────•────•────• \n**✯ JOIN ➪ [MOVIES GROUP 🎬](https://t.me/+l3_xaeVV6x1lMjk5)** \n*v✯ JOIN ➪ [MOVIE CHANNEL 🎥](https://t.me/+eWutUQKG6744YmVh)** \n•────•────•────• **★ᴊᴏɪɴ ★ ꜱʜᴀʀᴇ ★ ꜱᴜᴘᴘᴏʀᴛ**")
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "**📁 Title : <a href=>{title}** \n**📆 Year : <a href=/releaseinfo>{year}** \n**⭐ Rating : <a href=/ratings>{rating}</a>/10 \n**🔤 Language : {languages}</code>** ✯ ━━━━━━ ➿ ━━━━━━ ✯ \n**©️ GROUP</b> :[MOVIES CLUB 🎬](https://t.me/+l3_xaeVV6x1lMjk5)**")
